...
sub main {
    if (scalar(@ARGV) < 1) {
        print "\nrotasplit.pl -- - provides individual cvs files from a provided CSV file containing name of staff, info on shiftpattern, dates, date of week and  else. See rotasample.csv for a pattern\n";
